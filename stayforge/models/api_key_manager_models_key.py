...
class ApiKeyManagerModelsKey(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default='67500d3d4416b539e256ed02', description="Reference ID of the key.")
    ...
    effective_at: Optional[StrictStr] = Field(default='2024-12-04T08:05:17.570200Z', description="Effective at")
    ineffective_at: Optional[StrictStr] = Field(default='2024-12-05T08:05:17.570234Z', description="Ineffective at")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id") if obj.get("id") is not None else '67500d3d4416b539e256ed02',
            "create_at": obj.get("create_at"),
            "update_at": obj.get("update_at"),
            "url": obj.get("url"),
            "num": obj.get("num") if obj.get("num") is not None else '',
            "effective_at": obj.get("effective_at") if obj.get("effective_at") is not None else '2024-12-04T08:05:17.570200Z',
            "ineffective_at": obj.get("ineffective_at") if obj.get("ineffective_at") is not None else '2024-12-05T08:05:17.570234Z'
        })
        return _obj
