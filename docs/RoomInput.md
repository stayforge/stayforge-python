...
------------ | ------------- | ------------- | -------------
**key_id** | **str** | Reference ID of the key. | [optional] [default to '6764290a6f43adec3ce4fedf']
**room_type_id** | **str** | Reference ID of the RoomType. | [optional] [default to '6764290a6f43adec3ce4fee0']
