...
class Room(BaseModel):
    ...
    Room
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default='674f7eee58103c1ed7a444eb', description="Reference ID of the key.")
    create_at: Optional[datetime]
    update_at: Optional[datetime] = None
    key_id: Optional[StrictStr] = Field(default='674f7eee58103c1ed7a444ee', description="Reference ID of the key.")
    room_type_id: Optional[StrictStr] = Field(default='674f7eee58103c1ed7a444ef', description="Reference ID of the RoomType.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id") if obj.get("id") is not None else '674f7eee58103c1ed7a444eb',
            "create_at": obj.get("create_at"),
            "update_at": obj.get("update_at"),
            "key_id": obj.get("key_id") if obj.get("key_id") is not None else '674f7eee58103c1ed7a444ee',
            "room_type_id": obj.get("room_type_id") if obj.get("room_type_id") is not None else '674f7eee58103c1ed7a444ef',
