...
class Room(BaseModel):
    ...
    key_id: Optional[StrictStr] = Field(default='674f6e36ae65a0dc1f51f272', description="Reference ID of the key.")
    room_type_id: Optional[StrictStr] = Field(default='674f6e36ae65a0dc1f51f273', description="Reference ID of the RoomType.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "key_id": obj.get("key_id") if obj.get("key_id") is not None else '674f6e36ae65a0dc1f51f272',
            "room_type_id": obj.get("room_type_id") if obj.get("room_type_id") is not None else '674f6e36ae65a0dc1f51f273',
