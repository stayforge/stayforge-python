...
class Room(BaseModel):
    ...
    key_id: Optional[StrictStr] = Field(default='676429c0e0101c91bb881c36', description="Reference ID of the key.")
    room_type_id: Optional[StrictStr] = Field(default='676429c0e0101c91bb881c37', description="Reference ID of the RoomType.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "key_id": obj.get("key_id") if obj.get("key_id") is not None else '676429c0e0101c91bb881c36',
            "room_type_id": obj.get("room_type_id") if obj.get("room_type_id") is not None else '676429c0e0101c91bb881c37',
