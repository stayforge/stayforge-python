...
class ApiKeyManagerModelsKeyInput(BaseModel):
    ...
    effective_at: Optional[StrictStr] = Field(default='2024-12-04T08:54:13.901406Z', description="Effective at")
    ineffective_at: Optional[StrictStr] = Field(default='2024-12-05T08:54:13.901437Z', description="Ineffective at")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "effective_at": obj.get("effective_at") if obj.get("effective_at") is not None else '2024-12-04T08:54:13.901406Z',
            "ineffective_at": obj.get("ineffective_at") if obj.get("ineffective_at") is not None else '2024-12-05T08:54:13.901437Z'
        })
        return _obj
