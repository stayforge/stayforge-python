...
class BodyAuthenticateApiAuthAuthenticatePost(BaseModel):
    """
    BodyAuthenticateApiAuthAuthenticatePost
    """ # noqa: E501
    account: StrictStr = Field(description="Service Account Username (Must be an email address)")
    secret: StrictStr = Field(description="Service Account API Key (Or password for human user)")
    __properties: ClassVar[List[str]] = ["account", "secret"]
