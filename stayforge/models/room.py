...
class Room(BaseModel):
    ...
    key_id: Optional[StrictStr] = Field(default='67693e58eeeb6882308c34cf', description="Reference ID of the key.")
    room_type_id: Optional[StrictStr] = Field(default='67693e58eeeb6882308c34d0', description="Reference ID of the RoomType.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "key_id": obj.get("key_id") if obj.get("key_id") is not None else '67693e58eeeb6882308c34cf',
            "room_type_id": obj.get("room_type_id") if obj.get("room_type_id") is not None else '67693e58eeeb6882308c34d0',
