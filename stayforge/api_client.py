...
from stayforge.api_response import ApiResponse, T as ApiResponseT
import stayforge.models
from stayforge import rest
from stayforge.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
...
class ApiClient:
    ...
    def __init__(
        ...
        self.user_agent = 'OpenAPI-Generator/0.0.0-fa01ff3/python'
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(stayforge.models, klass)
