...
class ApiKeyManagerModelsKey(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default='676816748fa6503d7e0e9dff', description="Reference ID of the key.")
    ...
    effective_at: Optional[StrictStr] = Field(default='2024-12-22T13:39:00.915906Z', description="Effective at")
    ineffective_at: Optional[StrictStr] = Field(default='2024-12-23T13:39:00.915955Z', description="Ineffective at")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id") if obj.get("id") is not None else '676816748fa6503d7e0e9dff',
            "create_at": obj.get("create_at"),
            "update_at": obj.get("update_at"),
            "url": obj.get("url"),
            "num": obj.get("num") if obj.get("num") is not None else '',
            "effective_at": obj.get("effective_at") if obj.get("effective_at") is not None else '2024-12-22T13:39:00.915906Z',
            "ineffective_at": obj.get("ineffective_at") if obj.get("ineffective_at") is not None else '2024-12-23T13:39:00.915955Z'
        })
        return _obj
