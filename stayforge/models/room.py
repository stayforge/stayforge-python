...
class Room(BaseModel):
    ...
    key_id: Optional[StrictStr] = Field(default='6769462c2867ad69d752694d', description="Reference ID of the key.")
    room_type_id: Optional[StrictStr] = Field(default='6769462c2867ad69d752694e', description="Reference ID of the RoomType.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "key_id": obj.get("key_id") if obj.get("key_id") is not None else '6769462c2867ad69d752694d',
            "room_type_id": obj.get("room_type_id") if obj.get("room_type_id") is not None else '6769462c2867ad69d752694e',
