...
class TestRoomTypeBaseInput(unittest.TestCase):
    """RoomTypeBaseInput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RoomTypeBaseInput:
        """Test RoomTypeBaseInput
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RoomTypeBaseInput`
        """
        model = RoomTypeBaseInput()
        if include_optional:
            return RoomTypeBaseInput(
                parent = '',
                name = '',
                name_visible = '',
                description = '',
    ...
    def testRoomTypeBaseInput(self):
        """Test RoomTypeBaseInput"""
