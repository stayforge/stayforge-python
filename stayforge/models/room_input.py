...
class RoomInput(BaseModel):
    ...
    RoomInput
    """ # noqa: E501
    key_id: Optional[StrictStr] = Field(default='674f73c8ed8b36cf287af006', description="Reference ID of the key.")
    room_type_id: Optional[StrictStr] = Field(default='674f73c8ed8b36cf287af007', description="Reference ID of the RoomType.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "key_id": obj.get("key_id") if obj.get("key_id") is not None else '674f73c8ed8b36cf287af006',
            "room_type_id": obj.get("room_type_id") if obj.get("room_type_id") is not None else '674f73c8ed8b36cf287af007',
